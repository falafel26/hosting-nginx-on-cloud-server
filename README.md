...
## Lesson Learned
I created EC2 instancesusing two different methods. I learned opening sites on different ports if one is already used by the other instance. Also to stop and clean up the docker image after completing the use.
